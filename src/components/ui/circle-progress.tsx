...
const CircleProgress = ({
  ...
  const valueText =
    ...
    } out of ${maxValue}${props.suffix ? props.suffix : ""}, ${Math.round(
      fillPercentage * 100
    )}% complete`;
  ...
  return (
    ...
    >
      ...
      <img
        src="/cow.svg"
        alt="Cow"
        className="h-20 w-20 rounded-full bg-white absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10"
      />
